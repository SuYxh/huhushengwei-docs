const shop = [{ price: 100, count: 10 }, { price: 500, count: 20 }, { price: 99, count: 19 }]
...
// 简化上述代码
const compose = (...fns) => (...args) => fns.reduceRight((a, b) => b(a), fns.pop()(...args))
...
//   })
// }
const compose2 = (...fns) => fns.reduce((a, b) => (...args) => a(b(...args)))
