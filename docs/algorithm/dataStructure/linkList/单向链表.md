...
- 链表的火车结构
  ...
  ![链表的火车结构](https://qn.huat.xyz/mac/20220829103633.png)
...
- 链表的数据结构
  ...
  ![链表的数据结构](https://qn.huat.xyz/mac/20220829103753.png)

- 给火车加上数据后的结构

  ![给火车加上数据后的结构](https://qn.huat.xyz/mac/20220829103749.png)
...
- 首先让 `currentNode` 指向第一个节点。
  ...
  ![image](https://qn.huat.xyz/mac/20220829103804.png)

- 通过 `while` 循环使 `currentNode` 指向最后一个节点，最后通过 `currentNode.next = newNode`，让最后一个节点指向新节点 `newNode`。

  ![image](https://qn.huat.xyz/mac/20220829103809.png)
...
![image](https://qn.huat.xyz/mac/20220829103815.png)
